...
export default function Home() {
  ...
  return (
    <main>
      <Layout>
        <Toaster />
        <div className='max-w-xl m-auto grid gap-5 text-center justify-items-center p-5'>
          ...
          <div className="mx-auto flex w-fit gap-2 items-center my-5">
            <a href="https://github.com/alphadevking" target='_blank'>
              <FaGithubAlt className='text-5xl text-gray-950 hover:text-gray-900 hover:scale-125 duration-500' />
            </a>
            <a href="https://twitter.com/alphadevking_1" target='_blank'>
              <FaXTwitter className='text-5xl text-gray-950 hover:text-gray-900 hover:scale-125 duration-500' />
            </a>
          </div>
